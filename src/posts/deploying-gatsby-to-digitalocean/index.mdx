---
title: Deploying Gatsby to a DigitalOcean Droplet
...
I've written this guide to show the steps required in order to deploy your own [Gatsby](https://gatsbyjs.org) onto a DigitalOcean droplet.
